...
UUID = os.environ.get('UUID', '74280262-acae-4812-9540-3b70d14b0628')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nzag.faiz.us.kg:8008')      # 哪吒面板域名或ip, v1格式: nezha.xxx.com:8008, v0格式: nezha.xxx.com
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')          # v1哪吒请留空, v0哪吒的agent通信端口,自动匹配tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'JgARl5rWKs4k8TTuG1OgFcaxrxsjmpHl')            # v1哪吒的NZ_CLIENT_SECRET或v0哪吒agent密钥
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'modal.faiz.us.kg')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNmI3MzZhMDhiMzlmNDVlMzE2ZTdlMGNkODE2Yjc2ZDIiLCJ0IjoiMzgxMTE0ODQtMTU1OC00OTUyLTk1NGItOGE2MTkzNGUyNmI5IiwicyI6Ik9EZGlNemMxWm1NdFl6SXdPQzAwWVRoaUxXSXhaV0V0WldRd01EQXdObVJsWVdSbCJ9')            # Argo固定隧道密钥,留空即使用临时隧道
ARGO_PORT = int(os.environ.get('ARGO_PORT', '8808'))   # Argo端口,使用固定隧道token需在cloudflare后台设置端口和这里一致
